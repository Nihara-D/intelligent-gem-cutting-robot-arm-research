...
class HomeDashboard extends StatelessWidget {
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      shape: BoxShape.circle,
                      border:
                          Border.all(color: const Color(0xFF102216), width: 2),
                    ),
                  ),
                ),
              ],
  ...
  // Quick Actions
  // Row 1: Analyze Gemstone  |  Cut Guide       
  // Row 2: Gem Valuation                         
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          // ── Row 2: Gem Valuation (NEW) ────────────────────────────────────
          GestureDetector(
            onTap: () =>
                Navigator.pushNamed(context, '/gem-valuation-input'),
            child: const _ActionCard(
              title: 'Gem Valuation',
              subtitle: 'Detect defects & estimate value',
      ...
      child: Column(
        children: [
          ...
          _AnalysisListItem(
            ...
            imageUrl: 'assets/images/cut_recommendation_result/Cabochon.png',
            onTap: () {
          ...
          _AnalysisListItem(
            ...
            imageUrl: 'assets/images/cut_recommendation_result/cushion.png',
            onTap: () {
              Navigator.pushNamed(context, '/result_details', arguments: {
          ...
          _AnalysisListItem(
            ...
            statusColor: const Color(0xFF11D452),
            imageUrl: 'assets/images/cut_recommendation_result/oval.png',
            onTap: () {
              Navigator.pushNamed(context, '/cut_analysis_result',
                  arguments: {
                    'stoneType': 'Topaz',
                    'apiResult': {
            ...
            children: [
              GestureDetector(
                ...
                child: const _NavIcon(
                    icon: Symbols.home, label: 'Home', isActive: true),
              ),
              GestureDetector(
                behavior: HitTestBehavior.opaque,
                onTap: () =>
                    Navigator.pushNamed(context, '/detection_input'),
                child:
                    const _NavIcon(icon: Symbols.diamond, label: 'Analyze'),
              ),
              ...
              GestureDetector(
                ...
                onTap: () =>
                    Navigator.pushNamed(context, '/gem-valuation-input'),
                child: const _NavIcon(
                    icon: Symbols.price_change, label: 'Valuation'),
              ),
              GestureDetector(
                behavior: HitTestBehavior.opaque,
                onTap: () => Navigator.pushNamed(context, '/profile'),
                child:
                    const _NavIcon(icon: Symbols.person, label: 'Profile'),
              ),
            ],
          ),
        ),
...
//   accentColor — icon/border tint, defaults to green to keep existing cards identical
// =============================================================================
class _ActionCard extends StatelessWidget {
  ...
  const _ActionCard({
    ...
    this.accentColor = const Color(0xFF11D452),
  });
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: const Color(0xFF11D452).withOpacity(0.05)),
        ),
        child: Row(
          children: [
            ClipRRect(
